...
@Wid(widfile="MySQLDefinitions.wid", name="MySQLDefinitions",
        displayName="MySQLDefinitions",
        defaultHandler="mvel: new com.corp.concepts.process.automation.handler.mysql.MySQLWorkItemHandler()",
        documentation = "mysql/index.html",
        category = "mysql",
        icon = "MySQLDefinitions.png",
        parameters={
        ...
        mavenDepends={
            @WidMavenDepends(group="com.corp.concepts.process.automation.handler", artifact="mysql", version="7.39.0.Final-redhat-00005")
        },
        serviceInfo = @WidService(category = "mysql", description = "A custom MySQL service task",
                keywords = "",
