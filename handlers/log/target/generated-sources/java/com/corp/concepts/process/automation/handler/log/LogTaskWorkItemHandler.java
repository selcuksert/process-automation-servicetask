...
@Wid(widfile="CustomLogTask.wid", name="CustomLogTask",
        ...
        mavenDepends={
                @WidMavenDepends(group = "com.corp.concepts.process.automation.handler", artifact = "customlog", version = "7.39.0.Final-redhat-00005")
        },
        serviceInfo = @WidService(category = "customlog", description = "A custom logger task",
                keywords = "Log, Slf4j",
